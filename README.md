...
1. Open your Chromium browser of choice and navigate to `BROWSER-NAME://extensions/`.

2. Enable developer mode by toggling the switch in the top-right corner.

3. Click the `Load unpacked` button that appears near the top-left.

4. In the file browser dialog, select the `apex` folder.

5. Toggle the switch in the bottom-right corner of the extension box.
